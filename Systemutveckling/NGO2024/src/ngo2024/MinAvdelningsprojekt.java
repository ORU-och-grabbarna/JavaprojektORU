...
public class MinAvdelningsprojekt extends javax.swing.JFrame {
    ...
    /**
     * Creates new form MinAvdelningsprojekt
     */
    public MinAvdelningsprojekt(InfDB idb, String inloggadAnvandare) {
        this.idb = idb; //Databasuppkoppling
        this.inloggadAnvandare = inloggadAnvandare; //Inloggad användares e-postadress.   
        initComponents();
        minavdelningsprojekt();
    }
    
    public void minavdelningsprojekt(){
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MinAvdelningsprojekt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new MinAvdelningsprojekt().setVisible(true);
            }
        });
    }
